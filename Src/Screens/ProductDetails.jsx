        ...
        <SafeAreaView style={{ flex: 1, gap: 20, backgroundColor: 'white' }}>
            ...
            <View >
                ...
                <View style={styles.shareandbachview}>
                    <FontAwesome5 onPress={() => { nav.goBack(); }} name='chevron-left' color={'black'} size={28} />
                    <Feather name='share' color={'black'} size={28} />
                ...
                <View style={{ flex: 0.9, justifyContent: 'flex-end' }}>
                    {
                        storeData.some((value) => value.name == productdata.name) ?
                           ...
                           <TouchableOpacity onPress={()=>{ dispatch(addtoCart(productdata)); 
                            nav.navigate('Cart'); }}  activeOpacity={0.8} style={styles.basketbtn}>
